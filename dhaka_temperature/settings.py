"""
Django settings for dhaka_temperature project.
...
SECRET_KEY = 'django-insecure-q1c55dkh5)t%=sbde$t&k0^+s)l39syauohev^*)@d)hi-)4%o'
...
ROOT_URLCONF = 'dhaka_temperature.urls'
